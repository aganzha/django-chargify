...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CreditCard.chargify_id'
        db.add_column(u'chargify_creditcard', 'chargify_id',
                      self.gf('django.db.models.fields.IntegerField')(unique=True, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CreditCard.chargify_id'
        db.delete_column(u'chargify_creditcard', 'chargify_id')
