...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Subscription.canceled_at'
        db.add_column(u'chargify_subscription', 'canceled_at',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Subscription.canceled_at'
        db.delete_column(u'chargify_subscription', 'canceled_at')
