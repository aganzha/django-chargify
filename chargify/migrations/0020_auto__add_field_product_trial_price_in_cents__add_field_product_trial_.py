...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Product.trial_price_in_cents'
        db.add_column(u'chargify_product', 'trial_price_in_cents',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Product.trial_interval'
        db.add_column(u'chargify_product', 'trial_interval',
                      self.gf('django.db.models.fields.IntegerField')(default=2),
                      keep_default=False)

        # Adding field 'Product.trial_interval_unit'
        db.add_column(u'chargify_product', 'trial_interval_unit',
                      self.gf('django.db.models.fields.CharField')(default='month', max_length=32),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Product.trial_price_in_cents'
        db.delete_column(u'chargify_product', 'trial_price_in_cents')

        # Deleting field 'Product.trial_interval'
        db.delete_column(u'chargify_product', 'trial_interval')

        # Deleting field 'Product.trial_interval_unit'
        db.delete_column(u'chargify_product', 'trial_interval_unit')
